...
//    который реализует интерфейс Comparator и сравнивает объекты Student сначала по классу, а затем по возрасту.
...
public class StudentComparatorGrade implements Comparator<StudentCompar> {
